...
/**
 * Part that counts and displays the number of processing patterns in the AE2
 * network.
 * Uses AbstractMonitorPart for the rendering system but disables item
 * interaction.
 */
public class ProcessingPatternCounterPart extends AbstractMonitorPart implements IGridTickable {

    @PartModels
    public static final ResourceLocation MODEL_OFF = new ResourceLocation("ae2patterncounter",
            "part/processing_pattern_counter_off");
    @PartModels
    public static final ResourceLocation MODEL_ON = new ResourceLocation("ae2patterncounter",
            "part/processing_pattern_counter_on");
    ...
    public ProcessingPatternCounterPart(IPartItem<?> partItem) {
    ...
    private void updatePatternCount(IGrid grid) {
        ...
        try {
            ...
            // Count only processing patterns in the network
            ...
            for (var craftableItem : craftableItems) {
                ...
                for (var pattern : patterns) {
                    // Only count AEProcessingPattern (external machine recipes)
