...
public class CraftingPatternCounterPart extends AbstractMonitorPart implements IGridTickable {
    ...
    public CraftingPatternCounterPart(IPartItem<?> partItem) {
    ...
    private void updatePatternCount(IGrid grid) {
        ...
        try {
            ...
            // Count only crafting patterns in the network
            ...
            for (var craftableItem : craftableItems) {
                ...
                for (var pattern : patterns) {
                    // Only count AECraftingPattern (vanilla crafting recipes)
    ...
    public AEKey getDisplayed() {
        // TODO: For now return null, we'll create a custom renderer to display the
        // number
        // The default AE2 monitor rendering system doesn't easily support displaying
        // just numbers
        // without platform-specific code (AEItemKey.of requires Fabric API in common
        // module)
        return null;
    }
