...
/**
 * Part that counts and displays the number of stonecutting patterns in the AE2
 * network.
 * Uses AbstractMonitorPart for the rendering system but disables item
 * interaction.
 */
public class StonecuttingPatternCounterPart extends AbstractMonitorPart implements IGridTickable {

    @PartModels
    public static final ResourceLocation MODEL_OFF = new ResourceLocation("ae2patterncounter",
            "part/stonecutting_pattern_counter_off");
    @PartModels
    public static final ResourceLocation MODEL_ON = new ResourceLocation("ae2patterncounter",
            "part/stonecutting_pattern_counter_on");
    ...
    public StonecuttingPatternCounterPart(IPartItem<?> partItem) {
    ...
    private void updatePatternCount(IGrid grid) {
        ...
        try {
            ...
            // Count only stonecutting patterns in the network
            ...
            for (var craftableItem : craftableItems) {
                ...
                for (var pattern : patterns) {
                    // Only count AEStonecuttingPattern (stonecutter recipes)
